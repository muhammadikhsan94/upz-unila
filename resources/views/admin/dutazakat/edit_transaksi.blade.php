    ...
    <form id="formUpdate" class="form-horizontal" method="post" action="javascript:void(0)" enctype="multipart/form-data">
        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <textarea class="form-control" id="komentar" name="komentar" disabled>{{ $data['status']->komentar }}</textarea>
                </div>
            </div>

            <div class="modal-footer">
                <a href="{{route('duta.transaksi')}}" class="btn btn-link">Kembali</a>
    ...
    $(document).ready(function() {
        ...
        $('#formUpdate').on('submit', function(e) {
            ...
            $('#ok-button').click(function() {
                $.ajax({
                    type: "POST",
                    url: "{{route('duta.updateTransaksi')}}",
                    data: formData,
                    contentType: false,
                    processData: false,
                    beforeSend: function() {
