...
<div class="box box-info">
    ...
    <div class="box-body">
        <div class="col-md-6" style="margin-bottom: 20px;">
            <a class="btn btn-primary btn-md" href="{{url('/relawan/transaksi/tambah')}}">
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#tabel-transaksi').DataTable({
            ...
            ajax: {
                url: "{{ url('relawan/transaksi/getdata') }}",
            },
            "order": [[ 7, "asc" ]],
            "columnDefs": [
        ...
        $(document).on('click', '.detail', function() {
            ...
            $.ajax({
                method: "GET",
                url: "/relawan/transaksi/detail/" + id,
                dataType: "json",
        ...
        $(document).on('click', '.edit', function() {
            var id = $(this).attr('id');
            window.location = "/relawan/transaksi/edit/"+id;
        });

        $(document).on('click', '.bukti', function() {
            var id = $(this).attr('id');
            $('.bukti').attr('target', 'new');
            $('.bukti').attr('href', "/relawan/transaksi/bukti/"+id);
            // window.location = "/relawan/transaksi/bukti/"+id;
        });
        ...
        $('#ok-button').click(function() {
            $.ajax({
                url: "/relawan/transaksi/delete/" + user_id,
                method: "DELETE",
                data: {
                    "_token": "{{ csrf_token() }}",
                },
