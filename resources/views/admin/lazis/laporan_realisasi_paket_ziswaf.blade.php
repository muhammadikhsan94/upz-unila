...
<div class="box box-info">
    ...
    <form class="form-horizontal">
        <div class="box-body">
            <div class="col-md-6">
                <label for="wilayah" class="control-label">STATUS:</label>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#tabel-realisasi').DataTable({
            ...
            "orderFixed": [0, 'asc'],
            ajax: {
                url: "{{ url('/upz/laporan/realisasi-paketziswaf/getdata/0') }}",
            },
            columns: [{
                data: "id",
        ...
        $('#wilayah').change(function() {
            table.ajax.url('/upz/laporan/realisasi-paketziswaf/getdata/'+$(this).val()).load();
        });
