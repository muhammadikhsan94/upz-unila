        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form class="form-horizontal" role="form" action="javascript:void(0)" enctype="multipart/form-data">
                    ...
                    <div class="form-group ">
                        <label for="paket_zakat" class="col-sm-3 control-label">Paket Zakat</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" id="paket_zakat" name="paket_zakat" disabled>
                        </div>
                    </div>
