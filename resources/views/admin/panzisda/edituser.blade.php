    ...
    <form id="editUser" class="form-horizontal" method="post" action="javascript:void(0)" enctype="multipart/form-data">
        ...
        <div class="box-body">
            ...
            <div class="modal-footer">
                <a type="button" id="batal" name="batal" class="btn btn-secondary" href="{{route('panzisda.user')}}">Batal</a>
...
<div class="modal fade" id="resetPassword" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <form method="post" action="{{ route('panzisda.resetPassword') }}" enctype="multipart/form-data">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('click', '.batal', function() {
            window.location = "/fakultas_lembaga/user/";
        });
