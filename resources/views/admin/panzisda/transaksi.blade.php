...
<div class="box box-info">
    ...
    <div class="box-header with-border">
        ...
        <!-- <button type="button" class="btn btn-primary btn-xs mr-5 pull-right" data-toggle="modal" data-target="#exportExcel1">
            Export Data
        </button> -->
    </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        var table = $('#tabel-transaksi').DataTable({
            ...
            "columnDefs": [
                {"className": "dt-center", "targets": [0, 8, 9, 10]}
            ],
            // "order": [[ 8, "asc" ], [ 0, "asc" ]],
            columns: [{
                data: "id",
        ...
        $('#formValid').submit(function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{route('panzisda.updateStatus')}}",
                data: formDataValid,
                contentType: false,
                processData: false,
