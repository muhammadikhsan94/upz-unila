...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#status_transaksi').change(function() {
            table.ajax.url('/panziswil/transaksi_kurban/getdata/'+$(this).val()).load();
        });
        ...
        $(document).on('click', '.detail', function() {
            ...
            $.ajax({
                method: "GET",
                url: "/panziswil/transaksi_kurban/detail/" + id,
                dataType: "json",
                success: function(data) {
                    ...
                    if (data.panziswil_status == null && data.komentar == null) {
                        $('#btnValid').show();
                        $('#btnNonValid').show();
                    } else {
                        $('#btnValid').hide();
        ...
        $('#formValid').submit(function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{route('panziswil.updateStatusKurban')}}",
                data: formDataValid,
                contentType: false,
                processData: false,
                success: function (data) {
        ...
        $(document).on('click', '.edit', function() {
            var id = $(this).attr('id');
            window.location = "/panziswil/transaksi_kurban/edit/"+id;
        });
        ...
        $('#ok-button').click(function() {
            $.ajax({
                url: "/panziswil/transaksi_kurban/delete/" + trxId,
                method: "DELETE",
                data: {
                    "_token": "{{ csrf_token() }}",
                },
