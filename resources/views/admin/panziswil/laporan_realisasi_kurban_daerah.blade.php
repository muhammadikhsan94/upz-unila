                ...
                <table id="tabel-capaian" class="display" style="width: 100%">
                    <thead>
                        <tr class="bg-primary">
                            ...
                            <th colspan="4" style="text-align: center"> Laporan Relawan </th>
                            <th colspan="4" style="text-align: center"> Laporan PIC Jurusan </th>
                            <th colspan="4" style="text-align: center"> Laporan Fakultas/Lembaga/Biro </th>
                        </tr>
                        <tr class="bg-primary">
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#tabel-capaian').DataTable({
            ...
            ajax: {
                url: "realisasi_kurban_daerah/getdata",
            },
