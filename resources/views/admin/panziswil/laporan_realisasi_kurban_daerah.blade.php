...
<div class="box box-info">
    ...
    <div class="box-header with-border">
        <h3 class="box-title"><strong>Laporan Realisasi Validasi Data Transaksi</strong></h3>
    </div>
                ...
                <table id="tabel-capaian" class="display" style="width: 100%">
                    <thead>
                        <tr class="bg-primary">
                            ...
                            <th colspan="4" style="text-align: center"> Laporan Duta </th>
                            <th colspan="4" style="text-align: center"> Laporan Manager Group </th>
                            <th colspan="4" style="text-align: center"> Laporan Panzisda </th>
                        </tr>
                        <tr class="bg-primary">
                            <th> Kambing </th><th> Sapi </th><th> Pekurban </th><th> % </th>
                            <th> Kambing </th><th> Sapi </th><th> Pekurban </th><th> % </th>
                            <th> Kambing </th><th> Sapi </th><th> Pekurban </th><th> % </th>
                        </tr>
                    </thead>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#tabel-capaian').DataTable({
            ...
            ajax: {
                url: "/universitas/laporan/realisasi_kurban_daerah/getdata",
            },
            ...
            footerCallback: function( tfoot, data, start, end, display ) {
                ...
                $(api.column(6).footer()).html(
                    api.column(6).reduce(function () {
                        total = (realisasis1 / targets) * 100;
                        return total.toFixed(2) + ' %';
                    }, 0 + ' %')
                );
                $(api.column(10).footer()).html(
                    api.column(10).reduce(function () {
                        total = (realisasis2 / targets) * 100;
                        return total.toFixed(2) + ' %';
                    }, 0 + ' %')
                );
                $(api.column(14).footer()).html(
                    api.column(14).reduce(function () {
                        total = (realisasis3 / targets) * 100;
                        return total.toFixed(2) + ' %';
                    }, 0 + ' %')
                );
            }
