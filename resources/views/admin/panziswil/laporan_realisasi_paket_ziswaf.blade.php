...
<script>
    $(document).ready(function() {
        ...
        var table = $('#tabel-realisasi').DataTable({
            dom: 'Blfrtip',
            buttons: [
                {name: 'excelHtml5', extend: 'excelHtml5', text: 'Export to EXCEL', messageTop: 'Laporan Realisasi Paket Ziswaf - PANZISWIL', className: 'btn btn-default btn-sm', pageSize: 'A4', autoFilter: true, customize: function ( xlsx ){ var sheet = xlsx.xl.worksheets['sheet1.xml']; $('row c', sheet).attr( 's', '25' ); }, footer: true},
                {name: 'pdfHtml5', extend: 'pdfHtml5', text: 'Export to PDF', messageTop: 'Laporan Realisasi Paket Ziswaf - PANZISWIL', className: 'btn btn-default btn-sm', pageSize: 'A4', footer: true},
                {name: 'print', extend: 'print', text: 'PRINT', messageTop: 'Laporan Realisasi Paket Ziswaf - PANZISWIL', className: 'btn btn-default btn-sm', pageSize: 'A4', footer: true}
            ],
            "language": {
        ...
        $('#pilih_wilayah').change(function() {
            table.ajax.url('/panziswil/laporan/realisasi-paketziswaf/getdata/'+$(this).val()).load();
        });
