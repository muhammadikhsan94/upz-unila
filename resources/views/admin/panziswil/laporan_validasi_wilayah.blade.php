...
@section('title')
- Laporan Monitoring Validasi Data Transaksi Wilayah
@endsection
...
<div class="box box-info">
    ...
    <div class="box-header with-border">
        <h3 class="box-title"><strong>Laporan Monitoring Validasi Data Transaksi Wilayah</strong></h3>
    </div>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#tabel-validasi').DataTable({
            ...
            ajax: {
                url: "{{ url('universitas/laporan/validasi/wilayah/getdata') }}",
            },
            columns: [{
                data: "id",
