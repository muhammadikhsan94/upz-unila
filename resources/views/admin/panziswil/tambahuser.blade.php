    ...
    <form id="tambah_user" class="form-horizontal" method="post" action="javascript:void(0)" enctype="multipart/form-data">
        ...
        <div class="box-body">
            ...
            <div class="form-group ">
                ...
                <div class="col-sm-5">
                    <select data-size="5" id="id_wilayah" name="id_wilayah" class="selectpicker" data-live-search="true" title="Pilih Wilayah.."  oninvalid="this.setCustomValidity('data tidak boleh kosong!')" onchange="setCustomValidity('')" required>
            ...
            <div class="form-group " id="lembaga">
                ...
                <div class="col-sm-5">
                    <select data-size="5" id="id_lembaga" name="id_lembaga" class="selectpicker" data-live-search="true" title="Pilih Manajer.." oninvalid="this.setCustomValidity('data tidak boleh kosong!')" onchange="setCustomValidity('')">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('input:checkbox[id=id_jabatan_3]').change(function(){
            if(this.checked) {
        ...
        $('input:checkbox[id=id_jabatan_4]').change(function(){
            if(this.checked) {
                $('#atasan_manajer').show();
                $('#group').show();
        ...
        $('input:checkbox[id=id_jabatan_5]').change(function(){
            if(this.checked) {
                $('#lembaga').show();
                $('#id_lembaga').attr('required', '');
            }else{
                $('#lembaga').hide();
                $('#id_lembaga').removeAttr('required', '');
            }
        });
        ...
        $('#tambah_user').submit(function (e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{route('panziswil.simpanUser')}}",
                data: formData,
                contentType: false,
                processData: false,
                success: function (data) {
                    ...
                    $('#tambah_user')[0].reset();
                    window.location.replace("{{route('panziswil.user')}}");
                },
                error: function (data) {
                    var html = '';
