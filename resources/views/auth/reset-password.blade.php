                    ...
                    <div class="panel-body">
                        ...
                        <form id="formRegister" class="form-horizontal" method="post" action="{{ route('password.update') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group ">
                                <label for="email" class="col-sm-4 control-label">Masukkan Email</label>
                                <div class="col-sm-8">
                            ...
                            <div class="form-group ">
                                ...
                                <div class="col-sm-8">
                                    <input type="password" class="form-control" id="password" name="password" placeholder="Masukkan Password Baru" oninvalid="this.setCustomValidity('tidak boleh kosong!')" onchange="setCustomValidity('')" required>
                                </div>
                            </div>
