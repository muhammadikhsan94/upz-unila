        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ route('panziswil.kurbanIndex') }}"><i class="fa fa-home"></i>  <span>Beranda Kurban</span></a></li>
                    <li><a href="{{route('panziswil.kurban')}}"><i class="fa fa-list"></i>  <span>Kelola Transaksi Kurban</span></a></li>
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-list"></i>  <span>Kelola Laporan</span>
                            <span class="pull-right-container">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{ route('panziswil.getLaporanRealisasiKurbanDuta') }}"><i class="fa fa-list"></i>  <span>Realisasi Duta</span></a></li>
                            <li><a href="{{ route('panziswil.getLaporanRealisasiKurbanDaerah') }}"><i class="fa fa-list"></i>  <span>Realisasi Daerah</span></a></li>
                            <li><a href="{{ route('panziswil.getLaporanRincianKurban') }}"><i class="fa fa-list"></i>  <span>Rincian Kurban</span></a></li>
                            <li><a href="{{ route('panziswil.getLaporanMonitoringKurban') }}"><i class="fa fa-list"></i>  <span>Validasi Group</span></a></li>
                            <li><a href="{{ route('panziswil.getLaporanMonitoringKurbanDaerah') }}"><i class="fa fa-list"></i>  <span>Validasi Daerah</span></a></li>
                        </ul>
                    </li>
                </ul>
            </li>
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{ route('panzisda.getLaporanRealisasiManajer') }}"><i class="fa fa-list"></i>  <span>Realisasi Manajer</span></a></li>
                            <li><a href="{{ route('panzisda.getLaporanRincianKurban') }}"><i class="fa fa-list"></i>  <span>Rincian Kurban</span></a></li>
                            <li><a href="{{ route('panzisda.getLaporanKurban') }}"><i class="fa fa-list"></i>  <span>Monitoring Validasi</span></a></li>
                        </ul>
                    </li>
                </ul>
            </li>
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-files-o"></i>
                    <span>Sebagai PIC Fakultas/Lembaga/Biro</span>
                    <span class="pull-right-container">
                        <i class="fa fa-angle-left pull-right"></i>
                    </span>
                </a>
                <ul class="treeview-menu">
                    ...
                    <li class="header" style="background-color:#1c2529;color:#fff"><strong>Kurban</strong></li>
                    <li><a href="{{ route('manajerarea.kurbanIndex') }}"><i class="fa fa-home"></i>  <span>Beranda Kurban</span></a></li>
                    <li><a href="{{ route('manajerarea.getLaporanKurban') }}"><i class="fa fa-list"></i>  <span>Kelola Laporan Kurban</span></a></li>
                </ul>
            </li>
            @endif
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="header" style="background-color:#1c2529;color:#fff"><strong>Kurban</strong></li>
                    <li><a href="{{route('manajer.kurbanIndex')}}"><i class="fa fa-home"></i>  <span>Beranda Kurban</span></a></li>
                    <li><a href="{{route('manajer.kurban')}}"><i class="fa fa-list"></i>  <span>Kelola Transaksi Kurban</span></a></li>
                    <li><a href="{{route('manajer.getLaporanKurban')}}"><i class="fa fa-list"></i>  <span>Kelola Laporan Kurban</span></a></li>
                </ul>
            </li>
            @endif
            ...
            <li class="treeview">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ route('duta.laporan') }}"><i class="fa fa-list"></i>  <span>Kelola Laporan Zakat</span></a></li>
                    <li class="header" style="background-color:#1c2529;color:#fff"><strong>Kurban</strong></li>
                    <li><a href="{{route('duta.kurbanIndex')}}"><i class="fa fa-home"></i>  <span>Beranda Kurban</span></a></li>
                    <li><a href="{{route('duta.kurban')}}"><i class="fa fa-list"></i>  <span>Kelola Transaksi Kurban</span></a></li>
                    <li><a href="{{route('duta.getLaporanKurban')}}"><i class="fa fa-list"></i>  <span>Kelola Laporan Kurban</span></a></li>
                </ul>
            </li>
            @endif
