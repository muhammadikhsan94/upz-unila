...
Route::middleware(['auth:sanctum', 'verified'])->group(function () {
    ...
    Route::group(['prefix' => 'relawan', 'middleware' => ['dutazakat']], function() {
		...
		//KURBAN
		Route::get('/kurban', [App\Http\Controllers\DutaZakatController::class, 'kurbanIndex'])->name('duta.kurbanIndex');
		Route::get('/transaksi_kurban', [App\Http\Controllers\DutaZakatController::class, 'kurban'])->name('duta.kurban');
		Route::get('/transaksi_kurban/getdata', [App\Http\Controllers\DutaZakatController::class, 'getDataKurban'])->name('duta.getDataKurban');
		Route::get('/transaksi_kurban/tambah', [App\Http\Controllers\DutaZakatController::class, 'tambahKurban'])->name('duta.tambahKurban');
		Route::get('/transaksi_kurban/detail/{id}', [App\Http\Controllers\DutaZakatController::class, 'detailKurban'])->name('duta.detailKurban');
		Route::post('/transaksi_kurban/simpan', [App\Http\Controllers\DutaZakatController::class, 'simpanKurban'])->name('duta.simpanKurban');
		Route::get('/transaksi_kurban/edit/{id}', [App\Http\Controllers\DutaZakatController::class, 'editKurban'])->name('duta.editKurban');
		Route::post('/transaksi_kurban/edit/update', [App\Http\Controllers\DutaZakatController::class, 'updateKurban'])->name('duta.updateKurban');
		Route::delete('/transaksi_kurban/delete/{id}', [App\Http\Controllers\DutaZakatController::class, 'deleteKurban'])->name('duta.deleteKurban');
		...
		Route::get('/laporan/kurban', [App\Http\Controllers\DutaZakatController::class, 'getLaporanKurban'])->name('duta.getLaporanKurban');
    ...
    Route::group(['prefix' => 'pic_jurusan', 'middleware' => ['manajer']], function() {
		...
		//KURBAN
		Route::get('/kurban', [App\Http\Controllers\ManajerController::class, 'kurbanIndex'])->name('manajer.kurbanIndex');
		Route::get('/transaksi_kurban', [App\Http\Controllers\ManajerController::class, 'kurban'])->name('manajer.kurban');
		Route::get('/transaksi_kurban/getdata', [App\Http\Controllers\ManajerController::class, 'getDataKurban'])->name('manajer.getDataKurban');
		Route::get('/transaksi_kurban/detail/{id}', [App\Http\Controllers\ManajerController::class, 'detailKurban'])->name('manajer.detailKurban');
		Route::get('/transaksi_kurban/{id}', [App\Http\Controllers\ManajerController::class, 'getStatusKurban'])->name('manajer.getStatusKurban');
		Route::post('/transaksi_kurban/update', [App\Http\Controllers\ManajerController::class, 'updateStatusKurban'])->name('manajer.updateStatusKurban');
		...
		Route::get('/laporan/kurban', [App\Http\Controllers\ManajerController::class, 'getLaporanKurban'])->name('manajer.getLaporanKurban');
		Route::get('/laporan/kurban/getdata', [App\Http\Controllers\ManajerController::class, 'getDataLaporanKurban'])->name('manajer.getDataLaporanKurban');
    ...
    Route::group(['prefix' => 'pic_fakultas', 'middleware' => ['manajerarea']], function() {
		...
		//KURBAN
    	Route::get('/kurban', [App\Http\Controllers\ManajerAreaController::class, 'kurbanIndex'])->name('manajerarea.kurbanIndex');
		...
		Route::get('/laporan/kurban', [App\Http\Controllers\ManajerAreaController::class, 'getLaporanKurban'])->name('manajerarea.getLaporanKurban');
    ...
    Route::group(['prefix' => 'fakultas_lembaga', 'middleware' => ['panzisda']], function() {
		...
		//KURBAN
		Route::get('/kurban', [App\Http\Controllers\PanzisdaController::class, 'kurbanIndex'])->name('panzisda.kurbanIndex');
		Route::get('/transaksi_kurban', [App\Http\Controllers\PanzisdaController::class, 'kurban'])->name('panzisda.kurban');
		Route::get('/transaksi_kurban/getdata/{id}', [App\Http\Controllers\PanzisdaController::class, 'getDataKurban'])->name('panzisda.getDataKurban');
		Route::get('/transaksi_kurban/detail/{id}', [App\Http\Controllers\PanzisdaController::class, 'detailKurban'])->name('panzisda.detailKurban');
		Route::get('/transaksi_kurban/{id}', [App\Http\Controllers\PanzisdaController::class, 'getStatusKurban'])->name('panzisda.getStatusKurban');
		Route::post('/transaksi_kurban/update', [App\Http\Controllers\PanzisdaController::class, 'updateStatusKurban'])->name('panzisda.updateStatusKurban');
		...
		Route::get('/laporan/rincian_kurban', [App\Http\Controllers\PanzisdaController::class, 'getLaporanRincianKurban'])->name('panzisda.getLaporanRincianKurban');
		Route::get('/laporan/rincian_kurban/getdata/{id}', [App\Http\Controllers\PanzisdaController::class, 'getDataLaporanRincianKurban'])->name('panzisda.getDataLaporanRincianKurban');
		Route::get('/laporan/monitoring_kurban', [App\Http\Controllers\PanzisdaController::class, 'getLaporanKurban'])->name('panzisda.getLaporanKurban');
		Route::get('/laporan/monitoring_kurban/getdata/{id}', [App\Http\Controllers\PanzisdaController::class, 'getDataLaporanKurban'])->name('panzisda.getDataLaporanKurban');
		Route::get('/laporan/realisasi_manajer', [App\Http\Controllers\PanzisdaController::class, 'getLaporanRealisasiManajer'])->name('panzisda.getLaporanRealisasiManajer');
    ...
    Route::group(['prefix' => 'universitas', 'middleware' => ['panziswil']], function() {
		...
		//KURBAN
		Route::get('/kurban', [App\Http\Controllers\PanziswilController::class, 'kurbanIndex'])->name('panziswil.kurbanIndex');
		Route::get('/transaksi_kurban', [App\Http\Controllers\PanziswilController::class, 'kurban'])->name('panziswil.kurban');
		Route::get('/transaksi_kurban/getdata/{id}', [App\Http\Controllers\PanziswilController::class, 'getDataKurban'])->name('panziswil.getDataKurban');
		Route::get('/transaksi_kurban/detail/{id}', [App\Http\Controllers\PanziswilController::class, 'detailKurban'])->name('panziswil.detailKurban');
		Route::get('/transaksi_kurban/{id}', [App\Http\Controllers\PanziswilController::class, 'getStatusKurban'])->name('panziswil.getStatusKurban');
		Route::post('/transaksi_kurban/update', [App\Http\Controllers\PanziswilController::class, 'updateStatusKurban'])->name('panziswil.updateStatusKurban');
		...
		Route::get('/laporan/kurban', [App\Http\Controllers\PanziswilController::class, 'getLaporanKurban'])->name('panziswil.getLaporanKurban');
		Route::get('/laporan/kurban/getdata', [App\Http\Controllers\PanziswilController::class, 'getDataLaporanKurban'])->name('panziswil.getDataLaporanKurban');

		//LAPORAN KURBAN
		Route::get('/laporan/monitoring_kurban', [App\Http\Controllers\PanziswilController::class, 'getLaporanMonitoringKurban'])->name('panziswil.getLaporanMonitoringKurban');
		Route::get('/laporan/monitoring_kurban/getdata/{id}', [App\Http\Controllers\PanziswilController::class, 'getDataLaporanMonitoringKurban'])->name('panziswil.getDataLaporanMonitoringKurban');
		Route::get('/laporan/monitoring_kurban_daerah', [App\Http\Controllers\PanziswilController::class, 'getLaporanMonitoringKurbanDaerah'])->name('panziswil.getLaporanMonitoringKurbanDaerah');
		Route::get('/laporan/monitoring_kurban_daerah/getdata', [App\Http\Controllers\PanziswilController::class, 'getDataLaporanMonitoringKurbanDaerah'])->name('panziswil.getDataLaporanMonitoringKurbanDaerah');
		Route::get('/laporan/rincian_kurban', [App\Http\Controllers\PanziswilController::class, 'getLaporanRincianKurban'])->name('panziswil.getLaporanRincianKurban');
		Route::get('/laporan/rincian_kurban/getdata/{id}', [App\Http\Controllers\PanziswilController::class, 'getDataLaporanRincianKurban'])->name('panziswil.getDataLaporanRincianKurban');
		Route::get('/laporan/realisasi_duta', [App\Http\Controllers\PanziswilController::class, 'getLaporanRealisasiKurbanDuta'])->name('panziswil.getLaporanRealisasiKurbanDuta');
		Route::get('/laporan/realisasi_duta/getdata/{id}', [App\Http\Controllers\PanziswilController::class, 'getDataLaporanRealisasiKurbanDuta'])->name('panziswil.getDataLaporanRealisasiKurbanDuta');
		Route::get('/laporan/realisasi_kurban_daerah', [App\Http\Controllers\PanziswilController::class, 'getLaporanRealisasiKurbanDaerah'])->name('panziswil.getLaporanRealisasiKurbanDaerah');
